...
import { getOpenReaders } from "../../../integrations/zotero/reader";

export {
  LegacyReaderToolbarCleanup,
  LegacyReaderToolbarCleanup as ReaderToolbarController,
};

type LegacyReaderToolbarCleanupOptions = {
  pluginID: string;
};

class LegacyReaderToolbarCleanup {
  constructor(private readonly options: LegacyReaderToolbarCleanupOptions) {}
