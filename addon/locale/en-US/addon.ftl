...
sidebar-open-window = Open in new window
sidebar-restore-to-sidebar = Restore to sidebar
sidebar-window-navigation = Chat navigation
sidebar-window-controls = Detached window controls
sidebar-resize-window-navigation = Resize chat navigation
sidebar-expand-window-navigation = Expand chat navigation
sidebar-collapse-window-navigation = Collapse chat navigation
sidebar-expand-history = Expand conversation history
sidebar-collapse-history = Collapse conversation history
sidebar-expand-archived-sessions = Expand archived sessions
sidebar-collapse-archived-sessions = Collapse archived sessions
sidebar-window-placeholder = Zopilot is open in a separate window
...
sidebar-trace-tool-risk = Risk
sidebar-trace-tool-risk-read-only = Read-only
sidebar-trace-tool-risk-network = Uses network
sidebar-trace-tool-risk-write = May modify files
sidebar-trace-tool-risk-unknown = Unknown
sidebar-trace-tool-result = Result
sidebar-trace-tool-result-truncated = Result summary (truncated)
