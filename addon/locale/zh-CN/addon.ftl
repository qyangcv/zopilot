...
sidebar-prompt-title = 提示词标题
sidebar-prompt-body = 提示词内容
sidebar-prompt-save = 保存
sidebar-prompt-delete = 删除提示词
sidebar-prompt-no-variables = 无变量
sidebar-skills = 技能
sidebar-skill-enabled = 已启用
sidebar-skill-disabled = 未启用
sidebar-skill-empty = 没有匹配的技能
sidebar-skill-search = 搜索技能
sidebar-skill-requires-context = 需要上下文
sidebar-skill-reader-context = 阅读器
sidebar-skill-workspace-context = 工作区
