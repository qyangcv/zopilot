...
![工作区选择](./assets/preview_2/workspace.png)

**使用 @ 选择论文**

![使用 @](./assets/preview_2/@.png)

**插入自定义 prompt**

![prompt](./assets/preview_2/prompt.png)

**点击论文胶囊将 笔记 添加到上下文**

![item-treee](./assets/preview_2/note.png)
...
- Zotero Collection 支持，支持在文献库或子分类中选择多篇论文进行提问，也支持打开单篇论文进行提问
- 支持使用 Codex CLI (需要 Codex 订阅) 和 BYOK (OpenAI 兼容的 API)
- 支持会话历史保存 -->
